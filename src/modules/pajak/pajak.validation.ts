...
/**
 * Validation untuk query parameter GET /api/pajak/detail?nopol=xxx
 */
export const getPajakByNopolQuerySchema = z.object({
  query: z.object({
    nopol: z.string()
 ...
 */
export type GetPajakByNopolQuery = z.infer<typeof getPajakByNopolQuerySchema>;
